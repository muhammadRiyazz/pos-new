...
public interface IWoyouService extends android.os.IInterface
{
  ...
  public static abstract class Stub extends android.os.Binder implements woyou.aidlservice.jiuiv5.IWoyouService
  {
    ...
    static final int TRANSACTION_labelLocate = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
    static final int TRANSACTION_labelOutput = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
