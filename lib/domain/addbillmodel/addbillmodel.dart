...
List<AddToBillModel> addToBillModelFromJson(String str) =>
    List<AddToBillModel>.from(
        json.decode(str).map((x) => AddToBillModel.fromJson(x)));

String addToBillModelToJson(List<AddToBillModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class AddToBillModel {
  int id;
  int count = 0;
  // String codeorSku;
  String category;
  ...
  factory AddToBillModel.fromJson(Map<String, dynamic> json) => AddToBillModel(
        id: json["Id"],
